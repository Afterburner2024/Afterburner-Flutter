...
class StudyScheduleDialog extends StatelessWidget {
  final List<StudyPost> posts;

  const StudyScheduleDialog({super.key, required this.posts});
          ...
          children: [
            Row(
              children: [
                ...
                SizedBox(width: 8),
                Text("스터디 일정", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22)),
                Spacer(),
                IconButton(
            ...
            Expanded(
              child: ListView(
                children: posts.isEmpty
                    ? [Center(child: Text('진행 중인 스터디가 없습니다.', style: TextStyle(color: AppTheme.mainTextHint)))]
